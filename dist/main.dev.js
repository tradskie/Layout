  ...
  return regeneratorRuntime.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 5:
          _context.next = 7;
          return regeneratorRuntime.awrap(new web3.eth.Contract(minersAbi, minersAddr));

        case 7:
          minersContract = _context.sent;
          _context.next = 10;
...
function checkForBinanceChain() {
  var accounts;
  return regeneratorRuntime.async(function checkForBinanceChain$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return regeneratorRuntime.awrap(BinanceChain.enable());

        case 2:
          console.log(_typeof(window.BinanceChain));
...
function controlLoopFaster() {
  liveUpdateEggs(); // liveUpdatePeers()
...
function refreshData() {
  ...
  web3.eth.getBalance(currentAddr).then(function (result) {
  ...
  getMyEggs(function (eggs) {
    ...
    secondsuntilfull = eggstohatch1 - eggs / lastNumMiners; // console.log('secondsuntilfull ',secondsuntilfull,eggsToHatch1,eggs,lastNumMiners)
...
function updateSellPrice() {
  var eggstoselldoc = document.getElementById('sellprice'); //eggstoselldoc.textContent='?'
...
function copyRef() {
  ...
  displayModalMessage("copied link to clipboard"); //alert("Copied the text: " + copyText.value);
}
